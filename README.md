...
**Tor Custom Country🧅🌍**
```
sudo su -c "bash <(wget -qO- cdn.jsdelivr.net/gh/GFW4Fun/x-ui-pro/x-ui-pro.sh) -TorCountry US"
```

**Tor Random Country 🧅🎲**
```
sudo su -c "bash <(wget -qO- cdn.jsdelivr.net/gh/GFW4Fun/x-ui-pro/x-ui-pro.sh) -TorCountry XX"
```
