...
```
sudo su -c "$(type apt &>/dev/null&&echo apt||echo dnf) install -y wget;bash <(wget -qO- https://raw.githubusercontent.com/GFW4Fun/x-ui-pro/master/x-ui-pro.sh) -install yes -panel 1 -ONLY_CF_IP_ALLOW no"
```
> 
